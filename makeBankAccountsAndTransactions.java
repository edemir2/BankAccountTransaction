		...
		try
		{
			...
			for( int i = 0; i < inputLines.size(); )
			{
				...
				if( inn.startsWith("new BankAccount") )
				{
					...
					demir_BankAccount ba = new demir_BankAccount(lastName, firstName, checkingInitialValue, savingsInitialValue);
				...
				if( inn.startsWith("new EnhancedBankAccount") )
				{
					...
					double checkingInitialValue = Double.parseDouble(st.nextToken());
					double savingsInitialValue = Double.parseDouble(st.nextToken());
					demir_EnhancedBankAccount eba = new demir_EnhancedBankAccount(lastName, firstName, checkingInitialValue, savingsInitialValue);
